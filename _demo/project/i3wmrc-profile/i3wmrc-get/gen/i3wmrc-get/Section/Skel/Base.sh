...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME='i3wmrc-get'
	fi

	THE_CMD_FILE_PATH="${THE_CMD_DIR_PATH}/$THE_CMD_FILE_NAME"

	## https://github.com/samwhelp/note-about-i3wm/blob/gh-pages/_demo/project/i3wmrc-profile/i3wmrc-get/i3wmrc-get
	THE_SELF_UPDATE_URL='https://raw.githubusercontent.com/samwhelp/note-about-i3wm/gh-pages/_demo/project/i3wmrc-profile/i3wmrc-get/i3wmrc-get'
