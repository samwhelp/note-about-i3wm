...
# * https://github.com/samwhelp/note-about-i3wm/blob/gh-pages/_demo/project/i3wmrc-profile/i3wmrc-get/remote-install.sh
# * https://github.com/samwhelp/note-about-i3wm/blob/gh-pages/_demo/project/i3wmrc-profile/i3wmrc-get/i3wmrc-get
# * https://raw.githubusercontent.com/samwhelp/note-about-i3wm/gh-pages/_demo/project/i3wmrc-profile/i3wmrc-get/i3wmrc-get
...
## $ export DEBUG_I3WMRC_GET_INSTALL=true
is_debug () {
	if [ "$DEBUG_I3WMRC_GET_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="i3wmrc-get-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-i3wm/blob/gh-pages/_demo/project/i3wmrc-profile/i3wmrc-get/i3wmrc-get
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-i3wm/gh-pages/_demo/project/i3wmrc-profile/i3wmrc-get/i3wmrc-get'


	THE_TARGET_FILE_NAME="i3wmrc-get"
